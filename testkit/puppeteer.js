...
export const baseModalTestkitFactory = puppeteerUniTestkitFactoryCreator(load(require('../src/BaseModal/BaseModal.uni.driver')));
export const messageModalTestkitFactory = puppeteerUniTestkitFactoryCreator(load(require('../src/MessageModal/MessageModal.uni.driver')));
