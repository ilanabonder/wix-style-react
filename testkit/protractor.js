...
export const baseModalTestkitFactory = protractorUniTestkitFactoryCreator(load(require('../src/BaseModal/BaseModal.uni.driver')));
export const messageModalTestkitFactory = protractorUniTestkitFactoryCreator(load(require('../src/MessageModal/MessageModal.uni.driver')));
